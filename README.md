...
경력 초기부터 네이티브 iOS 개발을 중심으로 커리어를 시작해,
...
- WebView/Hybrid 구조에서 iOS 네이티브 기능을 단계적으로 분리·적용하며 리스크를 줄이는 방식의 개선
...
- 기술 스택보다 문제의 맥락과 원인을 먼저 파악하는 편입니다.
- 개인의 완성도보다 팀이 유지하고 확장할 수 있는 구조를 우선합니다.
- 새로운 기술이나 도구를 학습할 때, 실제 업무에 적용 가능한지부터 고민합니다.
- 서비스가 사용자에게 전달되고 운영되는 단계까지 책임지는 개발을 지향합니다.
- 요구사항, 가정, 결정 배경을 문서로 남겨 변경에도 흔들리지 않게 소통합니다.
- Apple Human Interface Guidelines(HIG)를 기준으로 UX 선택의 근거를 설명하고 대안을 제시합니다.
